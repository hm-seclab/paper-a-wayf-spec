...
const MakeCredentialRequest = @import("MakeCredentialRequest.zig");
const MakeCredentialResponse = @import("MakeCredentialResponse.zig");
const AuthenticatorData = @import("AuthenticatorData.zig");
...
pub fn authenticatorMakeCredential(
    ...
    const mcp = cbor.parse(MakeCredentialRequest, di, .{
    ...
    // ++++++++++++++++++++++++++++++++++++++++++++++++
    var status = verifyPinUvAuthParam(auth, mcp);
    ...
    // ++++++++++++++++++++++++++++++++++++++++++++++++
    var auth_data = AuthenticatorData{
        .rpIdHash = undefined,
        .flags = .{
    ...
    const ao = MakeCredentialResponse{
